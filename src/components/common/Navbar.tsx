    ...
    return (
        <div className="border-b-2 shadow-md bg-[#F3F2F2]">
            <div className="container mx-auto py-4 px-4 md:px-8">
                ...
                {/* Mobile Menu */}
                <div
                    className={`transition-transform  bg-[#F3F2F2] duration-300 overflow-hidden md:hidden ${isMobileMenuOpen ? "mt-4" : "hidden"
                        }`}
                >
                    <ul className="text-bg_primary text-[18px] flex flex-col gap-4 p-4">
                        ...
                        <li className="cursor-pointer font-medium">
                            <Link href="/education" onClick={() => setIsMobileMenuOpen(false)}>Education</Link>
                        </li>
                        <li className="cursor-pointer font-medium">
                            <Link href="/store" onClick={() => setIsMobileMenuOpen(false)}>Store</Link>
                        </li>
                        <li className="cursor-pointer font-medium">
                            <Link href="/member" onClick={() => setIsMobileMenuOpen(false)}>Member Area</Link>
                        </li>
                        <div className="flex gap-4 mt-4">
                            <LuSearch
                                className="text-bg_primary w-6 h-6 cursor-pointer"
