                            ...
                            <div key={course.id} className="flex-none w-full md:w-1/2 lg:w-1/3 px-2">
                                <div className="bg-white rounded-lg shadow-lg overflow-hidden">
                                    ...
                                    <div className="p-4">
                                        ...
                                        <Link href={`/productDetails/${course.id}`} className="w-full bg-bg_primary hover:bg-gray-700 text-white py-3 px-6 w-full block text-center rounded-md transition-colors duration-200">
                                            Order Now
                                        </Link>
                                    </div>
                                </div>
