        ...
        <div>
            <div className="container mx-auto py-[80px]">
                <div className="grid lg:grid-cols-2  grid-cols-1  justify-between items-center">
                    ...
                    <div>
                        <h2 className="font-bold text-4xl text-[#333333] leading-[62px] pb-2">Educational Resources at <br /> Your Fingertips</h2>
                        <p className="text-[#333333] font-semibold text-[20px]">Who we are.</p>
                        <p className="text-[#807D7D] text-[18px] pt-[14px] pb-[20px]">Event Horizon offers educational resources, YouTube course links, a store, and a members-only section with exclusive content while collecting user data for marketing</p>
                        ...
                        <div className="flex flex-col space-y-2">
                            <div className="flex gap-[12px] items-center">
                                ...
                                <p className="text-[#333333] text-[18px]">Learn with Experts</p>
                            </div>
                            <div className="flex gap-[12px] items-center">
                                <div className="bg-[#EBEBEB] rounded-full p-[9px]" >
