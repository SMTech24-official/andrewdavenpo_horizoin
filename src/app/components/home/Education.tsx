...
export default function Education() {
    ...
    return (
        <div className=" bg-[#F3F2F2] mx-auto py-[80px] sm:px-6 lg:px-8">
            <div className="container mx-auto">


                <div className="text-center mb-12">
                    <h1 className="text-[38px] font-bold text-gray-900 mb-2">Educational Resources</h1>
                    <p className="text-lg text-[#807D7D]">Explore the Most Popular Courses on YouTube and Start Learning Today!</p>
                </div>
