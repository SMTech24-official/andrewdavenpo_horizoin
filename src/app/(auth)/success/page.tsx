  ...
  return (
    <div className="h-[100vh] relative flex items-center justify-center">
      ...
      <div className="fixed inset-0">
        <Image src={blurStudent} alt="Background" fill className="object-cover blur-sm" priority />
      </div>

      {/* Success Modal */}
      <div className="relative z-10 bg-black rounded-2xl shadow-xl p-8 mx-4 w-full max-w-sm">
        <div className="flex flex-col items-center text-center">
          <Image src={successLogo} width={108} height={108} alt="lgo" />

          <h1 className="text-xl font-semibold mb-2">Password Changed Successfully</h1>
